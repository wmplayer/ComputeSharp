...
partial class IShaderGenerator
{
    ...
    internal static partial class BuildHlslSource
    {
            ...
            INamedTypeSymbol structDeclarationSymbol)
        {
            ...
            HlslDefinitionsHelper.DetectAndReportInvalidPropertyDeclarations(diagnostics, structDeclarationSymbol);
            ...
            ImmutableArray<(string Name, string Definition)> declaredTypes = HlslDefinitionsHelper.GetDeclaredTypes(diagnostics, structDeclarationSymbol, discoveredTypes, instanceMethods);
            ImmutableArray<(string Name, string Value)> definedConstants = HlslDefinitionsHelper.GetDefinedConstants(constantDefinitions);
